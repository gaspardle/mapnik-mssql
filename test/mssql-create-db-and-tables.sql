...
INSERT INTO test VALUES (geometry::STGeomFromText('MULTIPOLYGON (((1 1, 3 1, 3 3, 1 3, 1 1), (1.5 1.5, 2 1.5, 2 2, 1.5 2, 1.5 1.5)), ((-1 -1, -1 -2, -2 -2, -2 -1, -1 -1)))', 4326), 5432, 'multi ploygon', 'X', 1, 999, 0, 0.0, 0.0, 'A');
